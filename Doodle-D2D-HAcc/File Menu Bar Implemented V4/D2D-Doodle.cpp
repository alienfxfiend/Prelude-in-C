...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
    {
        ...
        case IDM_MODE_BRUSH:
            ...
            UpdateStatus(hwnd); UpdateMenuState(hwnd); InvalidateRect(hwnd, NULL, FALSE);
            break;
