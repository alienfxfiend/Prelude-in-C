...
INT_PTR CALLBACK AboutDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
    {
        ...
        // Now set the long About text /*4827+ 8903+ 10192+ 10192+ 11578+ 11885+ 11902+ 12014+ 12127+ 12413+*/
        const wchar_t* aboutText =
            L"Direct2D-based StickPool game made in C++ from scratch (13711+ lines of code) (non-OOP-based)\n"
            ...
            L"Copyright (C) 2026 Evans Thorpemorton, Entisoft Software Solutions.\n"
