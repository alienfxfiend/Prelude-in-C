...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_KEYDOWN:
    {
        ...
        if (wParam == VK_F2) {
            ...
            MessageBox(hwnd,
                L"Direct2D-based StickPool game made in C++ from scratch (11902+ lines of code)\n"
                ...
                L"About This Game", MB_OK | MB_ICONINFORMATION); /*4827+ 8903+ 10192+ 10192+ 11578+ 11885+*/
            return 0;
        }
