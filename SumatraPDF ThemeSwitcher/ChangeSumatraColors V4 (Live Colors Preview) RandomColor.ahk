...
Gui, Add, Button, gRandomColors x520 y110 w85 h24, Random ; << NEW
...
; =====================================================================
;  EXTRA :  Random colour generator
; =====================================================================

RandomColors:                               ; fires when the button is clicked
...
GetRandomHexColor()                         ; returns something like “#3A7FCD”
{
    Random, r, 0, 255
    Random, g, 0, 255
    Random, b, 0, 255
